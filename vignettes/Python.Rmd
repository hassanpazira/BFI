...
First go to *Google Colab* from https://colab.google or https://colab.research.google.com, and then click on *New Notebook*. Now, skip the two following sections and jump to the section [Python Script](#Python).
