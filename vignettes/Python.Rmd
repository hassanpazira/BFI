...
First go to *Google Colab* from https://developers.google.com/colab or https://colab.research.google.com, and then click on *New Notebook*. Now, skip the next two sections and proceed to the [Python Script](#Python) section.
