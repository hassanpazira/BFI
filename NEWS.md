# BFI v3.0.0 (Latest)
* In this release, the package has been updated to support the observational and non-randomized studies for all families.

# BFI v2.1.0
* In this release, the package has been updated to support a (semi-parametric) Cox model with an 'unspecified' baseline hazard, maximizing the partial log-likelihood.
